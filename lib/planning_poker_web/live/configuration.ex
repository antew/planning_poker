  ...
  def render(assigns) do
    ...
    <div class="max-w-md w-full flex flex-col rounded border bg-white text-black shadow">
      <div class="m-3">
        ...
        <form class="flex flex-col mt-3 items-start justify-around" phx-change="username" phx-debounce="2000">
          <label for="username" class="w-1/3 mb-1 uppercase text-sm tracking-wide">Username</label>
          <input id="username" class="w-full bg-gray-200 appearance-none border-2 border-gray-200 rounded p-2" type="text" name="username" placeholder="Your Name" value="<%= @username %>" maxlength="15"/>
        </form>
